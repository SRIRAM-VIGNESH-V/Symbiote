...
text = r"""
                        ...
                        _           __                          __    _       __     
    ____  _________    (_)__  _____/ /_   _______  ______ ___  / /_  (_)___  / /____ 
   / __ \/ ___/ __ \  / / _ \/ ___/ __/  / ___/ / / / __ `__ \/ __ \/ / __ \/ __/ _ \
  / /_/ / /  / /_/ / / /  __/ /__/ /_   (__  ) /_/ / / / / / / /_/ / / /_/ / /_/  __/
 / .___/_/   \____/_/ /\___/\___/\__/  /____/\__, /_/ /_/ /_/_.___/_/\____/\__/\___/ 
/_/              /___/                      /____/                                   
...
print(centered_text("PROJECT SYMBIOTE"))
print(centered_text(Fore.YELLOW + "Author: SRIRAM VIGNESH V,"))
...
def packet_detection(packet):
    ...
    if packet.haslayer(OSPF_Hdr):
        ...
        content.append("[*]  use cryptographic authentication")
        print_frame(title, content)
